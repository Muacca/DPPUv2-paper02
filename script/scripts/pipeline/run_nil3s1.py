#!/usr/bin/env python3
"""CLI wrapper for Nil³×S¹ topology."""
import argparse
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description="DPPUv2 Nil³×S¹ Runner")
    ...
    log_file = os.path.join(args.output_dir, f'run_nil3s1_{timestamp}.log')
    ...
    engine = Nil3S1Engine(mode, ny_variant, logger, ckpt)
    engine.run()
