...
def main():
    parser = argparse.ArgumentParser(description="DPPUv2 S³×S¹ Runner")
    ...
    log_file = os.path.join(args.output_dir, f'run_s3s1_{timestamp}.log')
    ...
    engine = S3S1Engine(mode, ny_variant, logger, ckpt)
    engine.run()
