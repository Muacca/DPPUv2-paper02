...
from sympy import S, simplify, Rational, diff, lambdify, Matrix
...
class BaseFrameEngine:
    ...
    def step_E4_10_nieh_yan_frame(self):
        ...
        # Full
        self.data['ny_density_full'] = simplify(N_TT - N_Ree)
    ...
    def step_E4_11_lagrangian(self):
        ...
        L = compute_lagrangian(
            ...
            weyl_scalar=self.data.get('weyl_scalar', S.Zero),
    ...
    def get_effective_potential_function(self):
        ...
        return lambdify(args, self.data['potential'], modules='numpy')
